              ...
              <div class="row">
                <div className="col-md-3 form-group mb-0 me-0">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label for="state" class="exp-form-labels" className={`${error && !Code ? 'text-danger' : ''}`}>Code<span className="text-danger">*</span></label>
                      </div>
                    </div>
                    <div className="input-group" title="Select the code">
                      ...
                      />
                      {mode !== "update" && (
                        <button onClick={handleClickOpen} class="inthdrcode position-absolute pb-2  me-5" required title="Add Header" >
                ...
                <div className="col-md-3 form-group mb-2  ">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label for="state" class="exp-form-labels" className={`${error && !codeDetails ? 'text-danger' : ''}`}> Code Detail<span className="text-danger">*</span> </label>
                      </div>
                    </div>
                    <input
                      id="idcode"
                ...
                <div className="col-md-3 form-group  mb-2 ">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label for="state" class="exp-form-labels" className={`${error && !intermediary_addr_1 ? 'text-danger' : ''}`}> Address 1<span className="text-danger">*</span></label>
                      </div>
                    </div>
                    <input
                      id="idaddr1"
                ...
                <div className="col-md-3 form-group mb-2 ">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label for="state" class="exp-form-labels" className={`${error && !intermediary_addr_2 ? 'text-danger' : ''}`}> Address 2<span className="text-danger">*</span> </label>
                      </div>
                    </div>
                    <input
                      id="idaddr2"
                ...
                <div className="col-md-3 form-group mb-2">
                  <div class="exp-form-floating">
                        <label for="state" class="exp-form-labels">Address 3</label>
                    <input
                      id="idaddr3"
                      class="exp-input-field form-control"
                      type="text"
                ...
                <div className="col-md-3 form-group mb-2">
                  <div class="exp-form-floating">
                    <label for="idaddr4" class="exp-form-labels">Address 4</label>
                    <input
                      id="idaddr4"
                      class="exp-input-field form-control"
                      type="text"
                ...
                <div className="col-md-3 form-group mb-2">
                  <div class="exp-form-floating">
                    <div>
                      <label for="state" class="exp-form-labels" className={`${error && !intermediary_area_code ? 'text-danger' : ''}`}>City<span className="text-danger">*</span> </label>
                    </div>
                ...
                <div className="col-md-3 form-group mb-2">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                        <label for="state" class="exp-form-labels" className={`${error && !intermediary_stat_code ? 'text-danger' : ''}`}> State<span className="text-danger">*</span></label>
                    </div>
                ...
                <div className="col-md-3 form-group mb-2">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label for="state" class="exp-form-labels" className={`${error && !intermediary_cnty_code ? 'text-danger' : ''}`}>Country<span className="text-danger">*</span></label>
                      </div>
                    </div>
                ...
                <div className="col-md-3 form-group mb-2">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label for="state" class="exp-form-labels" className="text-danger" className={`${error && !intermediary_imex_no ? 'text-danger' : ''}`}> IMEX No<span  className="text-danger">*</span></label>
                      </div>
                    </div>
                    <input
                      id="idimexno"
                ...
                <div className="col-md-3 form-group mb-2">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label for="state" class="exp-form-labels" className={`${error && !intermediary_office_no ? 'text-danger' : ''}`}>Office No<span className="text-danger">*</span></label>
                      </div>
                    </div>
                    <input
                      id="idofficeno"
                ...
                <div className="col-md-3 form-group mb-2">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label for="state" class="exp-form-labels" className={`${error && !intermediary_resi_no ? 'text-danger' : ''}`}> Residential No<span className="text-danger">*</span> </label>
                      </div>
                    </div>
                    <input
                      id="idresno"
              ...
              <div class="row">
                ...
                <div className="col-md-3 form-group mb-2">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label for="state" class="exp-form-labels" className={`${error && !intermediary_mobile_no ? 'text-danger' : ''}`}> Mobile No<span className="text-danger">*</span> </label>
                      </div>
                    </div>
                    <input
                      id="idmobno"
                ...
                <div className="col-md-3 form-group mb-2">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label for="state" class="exp-form-labels" className={`${error && !intermediary_fax_no ? 'text-danger' : ''}`}> Fax No<span className="text-danger">*</span></label>
                      </div>
                    </div>
                    <input
                      id="idfaxno"
                ...
                <div className="col-md-3 form-group mb-2">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label for="state" class="exp-form-labels" className={`${error && !intermediary_email_id ? 'text-danger' : ''}`}>Email ID<span className="text-danger">*</span></label>
                      </div>
                    </div>
                    <input
                      id="idemailid"
