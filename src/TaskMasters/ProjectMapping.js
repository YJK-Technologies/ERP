...
function Input({ }) {
  ...
  const [projectIdSC, setProjectIdSC] = useState("");
...
//       }, []);
  ...
  const handleChangeProjectSC = (selectedProjectSC) => {
    ...
    setProjectIdSC(selectedProjectSC ? selectedProjectSC.value : '');
  };
            ...
            <div class="row ms-2 me-2">
                <div className="col-md-3 form-group mb-2">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label for="sname" className="exp-form-labels">Project ID</label>
                      </div>
                    </div>
                    <Select
                      id="gradeid"
              ...
              <div className="col-md-3 form-group mb-2">
                  <div class="exp-form-floating">
                    <div class="d-flex justify-content-start">
                      <div>
                        <label for="sname" className="exp-form-labels">User ID</label>
                      </div>
                    </div>
                    <Select
                      id="gradeid"
