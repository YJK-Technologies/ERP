  ...
  return (
    <div className={`sidebar ${collapsed ? "collapsed" : ""}`}>
      <div className="sidebar-menu mt-2" id="">
        ...
        {hasAnyPermission(Master) && (
          <>
            ...
            {screenType.includes("EmployeeInfo") && (
              ...
              <div className=" ms-3">
                {screenType.includes("VisitorMaster") && (
                  <Link
                    to="/VisitorMaster"
                    className="nav-link"
                    title="Warehouse"
                  >
                    <div class="menu-item">
                      <PersonBadgeFill size={18} className="me-3" />
                      <span className={collapsed ? "hidden" : ""}>
                        Visitor Master
                      </span>
                    </div>
        ...
        {hasAnyPermission(Transaction) && (
          <>
            ...
            {screenType.includes("OpeningBalance") && (
              ...
              <div className=" ms-3">
                {screenType.includes("GatePass") && (
                  <Link to="/GatePass" className="nav-link" title="GatePass">
                    <div class="menu-item">
                      <svg
                        viewBox="0 0 1024 1024"
                        width="18"
              ...
              <div className=" ms-3">
                {screenType.includes("FaceAttendance") && (
                  <Link
                    to="/FaceAttendance"
                    className="nav-link"
                    title="Warehouse"
                  >
                    <div class="menu-item">
                      <PersonCheckFill size={18} className="me-3" />
                      <span className={collapsed ? "hidden" : ""}>
                        Biometric Face
                      </span>
                    </div>
        ...
        {hasAnyPermission(Ess) && (
          <>
            ...
            {screenType.includes("PayslipGenerator") && (
              ...
              {hasAnyPermission(["PayslipSalaryDays"]) && (
                <>
                  <div className="menu-item-container">
                    <Link
                      to="/PayslipSalaryDays"
                      className="nav-link"
                      title="Payslip Master"
                    >
                      <div
                        className="menu-item"
                        onClick={togglePayslipCollapse}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="20"
        ...
        {hasAnyPermission(Pms) && (
          <>
            <div
              className="menu-item"
              onClick={toggleMastertsCollapse}
              title="PMS"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className={`collapse ${MastersCollapsed ? "show" : ""}`}>
              ...
              {hasAnyPermission(["OpenTickets", "ProjectDetails"]) && (
                <>
                  <div
                    className="menu-item"
                    onClick={toggleMastertsCollapse}
                      ...
                      {screenType.includes("ProjectDetails") && (
                        ...
                        >
                          <div class="menu-item">
                            ...
                            >
                              <path
                                d="M7 4H17C18.1 4 19 4.9 19 6V20C19 21.1 18.1 22 17 22H7C5.9 22 5 21.1 5 20V6C5 4.9 5.9 4 7 4Z"
                                stroke="currentColor"
                                strokeWidth="2"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                              />
                              <path
                                d="M9 2H15C16.1 2 17 2.9 17 4H7C7 2.9 7.9 2 9 2Z"
                                stroke="currentColor"
                                strokeWidth="2"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                    ...
                    <div className="ms-3">
                      {screenType.includes("TaskHours") && (
                        <Link
                          to="/TaskHours"
                          className="nav-link"
                          title="Task Hours & Time Tracking"
                        >
                          <div class="menu-item">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
            ...
            <div className={`collapse ${CRMCollapsed ? "show" : ""}`}>
              ...
              <div className="menu-item ms-3 mt-1">
                {screenType.includes("Forcast") && (
                  <Link to="/Forcast" className="nav-link" title="Forecast">
                    <div>
              ...
              <div className="menu-item ms-3 mt-1">
                {screenType.includes("CRMSalesActivity") && (
                  ...
                  >
                    <div>
                      <Activity size={18} className="me-3" />
                      <span className={collapsed ? "hidden" : ""}>
                        Activity
                      </span>
                    </div>
              ...
              <div className="menu-item ms-3 mt-1">
                {screenType.includes("Campaign") && (
                  ...
                  >
                    <div>
                      <UserSearch size={18} className="me-3" />
                      <span className={collapsed ? "hidden" : ""}>
                        Customer
                      </span>
                    </div>
